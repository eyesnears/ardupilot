...
typedef enum MAV_CMD
{
	...
	MAV_CMD_NAV_ALTITUDE_WAIT=83, /* Mission command to wait for an altitude or downwards vertical speed. This is meant for high altitude balloon launches, allowing the aircraft to be idle until either an altitude is reached or a negative vertical speed is reached (indicating early balloon burst) |altitude (m)| descent speed (m/s)| Empty| Empty| Empty| Empty| Empty|  */
	MAV_CMD_NAV_LOITER_DESCEND=84, /* Loiter around the given location until the vehicle drops below the given relative altitude. Designed for gliders needing to descend to a given altitude. |Empty| Empty| Radius around MISSION, in meters. If positive loiter clockwise, else counter-clockwise| Empty| Latitude| Longitude| Altitude|  */
